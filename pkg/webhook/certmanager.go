...
import (
	"github.com/jetstack/cert-manager/pkg/internal/apis/certmanager/authentication"
...
var (
	...
	AuthenticateCertificate    = authentication.NewCertificateAuthenticator() // ICP - added authenticator
)
