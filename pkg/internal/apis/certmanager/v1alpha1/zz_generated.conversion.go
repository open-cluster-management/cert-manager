...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.X509Subject)(nil), (*certmanager.X509Subject)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_X509Subject_To_certmanager_X509Subject(a.(*v1alpha1.X509Subject), b.(*certmanager.X509Subject), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.X509Subject)(nil), (*v1alpha1.X509Subject)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_X509Subject_To_v1alpha1_X509Subject(a.(*certmanager.X509Subject), b.(*v1alpha1.X509Subject), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_certmanager_CertificateSpec_To_v1alpha1_CertificateSpec(in *certmanager.CertificateSpec, out *v1alpha1.CertificateSpec, s conversion.Scope) error {
	out.Subject = (*v1alpha1.X509Subject)(unsafe.Pointer(in.Subject))
	out.CommonName = in.CommonName
	out.Organization = *(*[]string)(unsafe.Pointer(&in.Organization))
	out.Duration = (*metav1.Duration)(unsafe.Pointer(in.Duration))
	out.RenewBefore = (*metav1.Duration)(unsafe.Pointer(in.RenewBefore))
...
func autoConvert_v1alpha1_X509Subject_To_certmanager_X509Subject(in *v1alpha1.X509Subject, out *certmanager.X509Subject, s conversion.Scope) error {
...
// Convert_v1alpha1_X509Subject_To_certmanager_X509Subject is an autogenerated conversion function.
func Convert_v1alpha1_X509Subject_To_certmanager_X509Subject(in *v1alpha1.X509Subject, out *certmanager.X509Subject, s conversion.Scope) error {
	return autoConvert_v1alpha1_X509Subject_To_certmanager_X509Subject(in, out, s)
}

func autoConvert_certmanager_X509Subject_To_v1alpha1_X509Subject(in *certmanager.X509Subject, out *v1alpha1.X509Subject, s conversion.Scope) error {
	out.Countries = *(*[]string)(unsafe.Pointer(&in.Countries))
	out.OrganizationalUnits = *(*[]string)(unsafe.Pointer(&in.OrganizationalUnits))
	out.Localities = *(*[]string)(unsafe.Pointer(&in.Localities))
	out.Provinces = *(*[]string)(unsafe.Pointer(&in.Provinces))
...
// Convert_certmanager_X509Subject_To_v1alpha1_X509Subject is an autogenerated conversion function.
func Convert_certmanager_X509Subject_To_v1alpha1_X509Subject(in *certmanager.X509Subject, out *v1alpha1.X509Subject, s conversion.Scope) error {
	return autoConvert_certmanager_X509Subject_To_v1alpha1_X509Subject(in, out, s)
}
